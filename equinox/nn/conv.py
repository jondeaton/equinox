...
class Conv(Module):
    ...
    def __init__(
        ...
        padding: Union[int, Sequence[int], Sequence[Sequence[int]]] = 0,
...
class Conv2d(Conv):
    ...
    def __init__(
        ...
        padding: Union[int, Sequence[int], Sequence[Sequence[int]]] = (0, 0),
...
class Conv3d(Conv):
    ...
    def __init__(
        ...
        padding: Union[int, Sequence[int], Sequence[Sequence[int]]] = (0, 0, 0),
